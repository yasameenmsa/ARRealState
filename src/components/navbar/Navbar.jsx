...
const Navbar = () => {
  ...
  useEffect(() => {
    setState(prev => {
      return {...prev, continent: 'Dubai', type: 'beach'}
    })
  }, [])
    ...
    <div className={`${classes.container} ${isScrolled && classes.scrolled}`}>
      <div className={classes.wrapper}>
        ...
        <ul className={classes.center}>
          ...
          <li className={classes.listItem}>
          <Link to="/properties?type=All&continent=0&priceRange=0">Properties</Link>
          </li>
        </ul>
        ...
        <div className={classes.listPropertyForm} onClick={handleCloseForm}>
          <div className={classes.listPropertyWrapper} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleListProperty}>
              ...
              <select defaultValue={"Select Type"} value={state?.type} required name='type' onChange={handleState}>
              ...
              <select defaultValue={"Select Emirate"} value={state?.continent} required name='Continent' onChange={handleState}>

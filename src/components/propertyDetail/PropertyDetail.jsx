...
const PropertyDetail = () => {
  ...
  const handleBookmark = async () => {
    ...
    function handleChatWithOwner(username) {
       console.log(`Chatting with owner: ${username}`);
     }
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.wrapper}>
        ...
        <div className={classes.rightedite}> 
        <div className={classes.controls}>
          ...
          <div className={classes.details}>
            <div className={classes.typeAndContinent}>
              ...
              <div>Emirite: <span>{`${propertyDetail?.continent}`}</span></div>
            </div>
          ...
          {user?._id != null && (user?._id !== propertyDetail?.currentOwner?._id.toString()) &&
            <div className={classes.contactBookmarkControls}>
              ...
              {/* <button
                type="submit"
                onClick={() => handleChatWithOwner(propertyDetail?.currentOwner?.username)}
